                                            ...
                                            if (!Config::IS_FREE) {
                                                ...
                                                if (!$activation_result['message'] == 'NO_LICENSE_KEY') {
                                                    ...
                                                    <div>
                                                        ...
                                                        <br>
                                                        <input class="bc-uk-input" value="" type="text" id="license-key"
                                                               placeholder="Your license key">
                                                        <p></p>
                                                    </div>

                                                    <button id="activate-license-button"
                                                            class="bc-uk-button-primary bc-uk-button">Activate license
                                                    </button>
                                                    <?php
                                                }
                            ...
                            <li class="bc-single-tab" id="create-design-tab">
                                <div class="bc-uk-flex" bc-uk-grid>
                                    <div class="bc-uk-width-auto@m">
                                        <a href="<?php echo admin_url('admin.php?page=bc_menu_bar_cart&active_tab=create-design-tab'); ?>"
                                           class="bc-uk-button bc-uk-button-primary">Create new design</a>
