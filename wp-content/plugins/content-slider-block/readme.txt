...
Display your goal to your visitor in a beautiful way with the content slider block.
...
- Different Background: Set different types of backgrounds, such as solid, gradient and image. Keep blank the title, description, and button and transparent the overlay color to make the Image slider.
- Elements settings: Change the elements settings such as show hide title, description, and button. Also, change the typography settings of them.
